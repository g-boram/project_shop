    ...
    <>
      ...
      <ManagerPageLayout>
        <SettingContainer>
                ...
                <>
                  {user?.uid === board.uid ? (
                    <Button
                      ...
                      color="primary"
                      onClick={() =>
                        navigate(`/manager/board/edit/${board.id}`)
                      }
                    >
                      수정
                    </Button>
          ...
          <Spacing size={20} />
          <ManagerCommentBox board={board} getDetailBoard={getDetailBoard} />
          <Spacing size={20} />
        </SettingContainer>
      </ManagerPageLayout>
    </>
...
const NoticeBox = styled.div`
  ...
  box-shadow: 0px 0px 10px -2px #cdcdff;
  height: 60px;
  width: 90%;
  margin-top: 50px;
  border-radius: 8px;
